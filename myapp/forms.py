...
from .models import Coupon, Category, Company, UserProfile
...
class CouponForm(forms.ModelForm):
  class Meta:
    model = Coupon
    fields = ['title', 'description', 'code','category', 'company', 'validity', 'image']
    widgets = {
      'validity' : forms.TextInput(attrs={'id':'datepicker', 'class':'form-control'}),
      ...
      # 'used' : forms.TextInput(attrs={'class':'form-control'}),
    }
